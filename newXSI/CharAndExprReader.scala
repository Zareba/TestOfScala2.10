...
object CharAndExprReader {
    final val EofCh = '\032'
}

class CharAndExprReader[E](charSource: Array[java.lang.CharSequence], eSource: Array[E], override val offset: Int) extends EitherReader[Char, E] {
    import CharAndExprReader._
    ...
    def rest: CharAndExprReader[E] = if (offset < length) new CharAndExprReader[E](charSource, eSource, offset + 1) else this
    ...
    override def drop(n: Int): CharAndExprReader[E] = new CharAndExprReader[E](charSource, eSource, offset + n)
}